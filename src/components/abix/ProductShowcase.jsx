...
const SHOWCASE_PRODUCTS = [
  {
    ...
    name: 'Shilajit',
    tagline:
      featuredProduct?.tagline || 'Ancient origin. Modern experience.',
    image: shilajitJarImg,
  },
  {
    id: 'triphala',
    name: 'Triphala',
    tagline: 'Herbal daily wellness',
    image: triphalaImg,
  },
  {
    id: 'ashwagandha',
...
export default function ProductShowcase() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Subtle environmental overlay */}
        <div
          className="absolute inset-0 z-[1] pointer-events-none"
          style={{
            background:
              'linear-gradient(180deg, rgba(32,40,31,0.35) 0%, rgba(32,40,31,0.6) 100%)',
          }}
          aria-hidden="true"
        />
