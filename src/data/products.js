...
// Shop page + "coming soon" product assets.
import shilajitShop from '@/assets/products/shilajit-shop.png';
import orthavedaImg from '@/assets/products/orthoveda.png';
...
// NOTE: HERO_IMAGE and the strings below are not used anywhere.
// Kept only so nothing else that might reference the constant names breaks.
export const HERO_IMAGE =
  "https://media.base44.com/images/public/6a9ba7f03e79451798a06d5a/8d3bf021c_generated_a2b6155e.jpg";

export const PRODUCT_IMAGE =
  "https://media.base44.com/images/public/6a9ba7f03e79451798a06d5a/250b02195_generated_3433b404.jpg";

export const SOURCING_IMAGE =
  "https://media.base44.com/images/public/6a9ba7f03e79451798a06d5a/3fd09bfe9_generated_c687c2de.jpg";

export const PURIFICATION_IMAGE =
  "https://media.base44.com/images/public/6a9ba7f03e79451798a06d5a/e96b0f8b3_generated_efecda09.jpg";

export const RITUAL_IMAGE =
  "https://media.base44.com/images/public/6a9ba7f03e79451798a06d5a/9bfa04525_generated_0ecb7692.jpg";

export const MIST_IMAGE =
  "https://media.base44.com/images/public/6a9ba7f03e79451798a06d5a/286eac8b6_generated_e48ac1e8.jpg";

// The ONLY approved product asset used in the hero — real ABIXMART Shilajit
// jar, background-removed from the supplied product photo.
...
// Real Himalayan environment photo for the hero background.
export const HERO_BACKGROUND_IMAGE = heroBg;

// Dynamic hero product set for dev/testing the GSAP product-switch transition.
// Product 1 is the real approved Shilajit asset.
// Products 2 and 3 are temporary placeholders only.
...
export const productBenefits = [
  {
    ...
    body: 'Shilajit helps improve energy levels and reduces fatigue naturally.',
  },
  {
    key: 'strength',
    title: 'Strength & Stamina',
    body: 'Supports physical performance, stamina and muscle strength.',
  },
  {
    key: 'focus',
    title: 'Enhances Focus & Memory',
    body: 'Improves cognitive function, focus and mental clarity.',
  },
  {
    key: 'immunity',
    title: 'Supports Immunity',
    body: 'Rich in minerals and fulvic acid that help strengthen immune health.',
  },
  {
    key: 'origin',
    title: '100% Pure Himalayan Shilajit',
    body: 'Sourced from high-altitude Himalayan rocks for maximum potency and purity.',
  },
  {
    key: 'wellness',
    title: 'Overall Wellness',
    body: 'Promotes overall vitality, balance and well-being.',
  },
];
...
export const storyStages = [
  {
    num: "01",
    title: "Sourcing",
    text: "Raw Shilajit is gathered from the high-altitude rocks of the Himalayas, where it forms over centuries.",
  },
  {
    num: "02",
    title: "Collection",
    text: "Collected by hand in small quantities, with care for the mountain and its rhythms.",
  },
  {
    num: "03",
    title: "Purification",
    text: "The raw resin is gently purified using traditional methods to remove impurities.",
  },
  {
    num: "04",
    title: "Quality Testing",
    text: "Each batch is checked for quality before it moves forward in the process.",
  },
  {
    num: "05",
    title: "Concentration",
    text: "The purified resin is slowly concentrated to a rich, consistent texture.",
  },
  {
    num: "06",
    title: "Resin Formulation",
    text: "Formulated into the smooth resin you receive — nothing rushed, nothing added.",
  },
  {
    num: "07",
    title: "Filling",
    text: "Each jar is filled by hand in small batches.",
  },
  {
    num: "08",
    title: "Sealing & Packaging",
    text: "Sealed to preserve freshness and packaged with care.",
  },
  {
    num: "09",
    title: "Final Check",
    text: "A final review of every jar before it leaves us.",
  },
  {
    num: "10",
    title: "Ready To Reach You",
    text: "From the mountain to your hands — ready to become part of your ritual.",
  },
];
...
export const whyAbixmart = [
  {
    ...
    text: "Sourced from the high Himalayas.",
  },
  {
    title: "Ayurvedic Formulation",
    text: "Rooted in traditional practice.",
  },
  {
    title: "Quality Focus",
    text: "Every batch is reviewed before it reaches you.",
  },
  {
    title: "Transparent Process",
    text: "Ten stages, shown openly — nothing hidden.",
  },
  {
    title: "Carefully Crafted",
    text: "Small batches, made with intention.",
  },
];
...
export const trustPillars = [
  ...
  },
  {
    ...
    body: "We share our process openly. No invented certifications, no fabricated lab results, no claims we cannot stand behind.",
  },
];
...
export const upcomingProducts = [
  {
    name: "Ashwagandha",
    note: "For calm and resilience.",
    status: "Coming Soon",
  },
  {
    name: "Triphala",
    note: "A traditional three-fruit blend.",
    status: "Coming Soon",
  },
  {
    name: "Amla",
    note: "Vitamin-rich botanical.",
    status: "Coming Soon",
  },
  {
    name: "Moringa",
    note: "Leaf of the miracle tree.",
    status: "Coming Soon",
  },
];
...
export const supportOptions = [
  {
    ...
    desc: "Browse the shop and check out simply.",
    to: "/shop",
    icon: "ShoppingBag",
  },
  {
    key: "understand",
    label: "I want to understand a product",
    desc: "Know what goes into ABIXMART.",
    to: "/shop/shilajit",
    icon: "BookOpen",
  },
  {
    key: "order",
    label: "I already placed an order",
    desc: "View confirmation and details.",
    to: "/support#tracking",
    icon: "Package",
  },
  {
    ...
    desc: "Where is my order right now?",
    to: "/support#tracking",
    icon: "Truck",
  },
  {
    ...
    desc: "Find answers in our FAQ.",
    to: "/support#faq",
    icon: "HelpCircle",
  },
  {
    key: "talk",
    label: "Talk to ABIXMART",
    desc: "Reach us on WhatsApp or email.",
    to: "/support#contact",
    icon: "MessageCircle",
  },
];
...
export const orderSteps = [
  ...
  },
  {
    key: "packed",
    label: "Packed",
    desc: "Your jar is filled, sealed and packed.",
  },
  {
    key: "shipped",
    label: "Shipped",
    desc: "On its way from the Himalayas to you.",
  },
  {
    key: "out",
    label: "Out for Delivery",
    desc: "Arriving today, near you.",
  },
  {
    key: "delivered",
    label: "Delivered",
    desc: "Now part of your daily ritual.",
  },
];
